  ...
  return (
    <>
      <div className={cx("search")}>
        ...
        >
          <SearchItem IconBefore={faBuilding} text={queries.category} defaultText = {"Tìm tất cả"}/>
        </span>
        <span
        ...
        <span className={cx("search__item")}>
          <Button text="Tìm kiếm" IcBefore={faMagnifyingGlass} searchBtn onClick={handleSearch}/>
        </span>
      </div>
